...
maintainers responsible for enforcement by opening a private report through GitHub's
[private vulnerability reporting](https://github.com/spectra-g/clawdence/security/advisories/new)
form, which is not publicly visible.
...
> **Note for the maintainer:** before this repository is made public, replace the reporting
> channel above with a monitored email address. A reporting channel nobody watches is worse than
> none, because it implies a promise.
